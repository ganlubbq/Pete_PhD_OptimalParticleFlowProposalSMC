function [state, ppsl_prob] = drone_ukfproposal( model, prev_state, obs, state )
%drone_ukfproposal Sample and/or evaluate UKF approximation of the OID
% for the drone model.
