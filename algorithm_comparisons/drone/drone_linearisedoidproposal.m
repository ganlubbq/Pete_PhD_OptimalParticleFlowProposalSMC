function [state, ppsl_prob] = drone_linearisedoidproposal( model, prev_state, obs, state )
%drone_linearisedoidproposal Sample and/or evaluate approximation of the
% OID linearised around a local maximum for the drone model.
...
if nargout > 2
    ...
    % Preliminary bits
    T = drone_obssecondderivtensor(model, x);
