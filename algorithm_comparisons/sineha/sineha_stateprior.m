...
%     tau = T + gamrnd(model.tau_shape, (model.tau_mn-model.T1_mn)/model.tau_shape);
    tau = gamrnd(model.tau_shape, model.tau_mn/model.tau_shape);
...
%         prob = prob + log(gampdf(tau-T, model.tau_shape, (model.tau_mn-model.T1_mn)/model.tau_shape));
        prob = prob + log(gampdf(tau, model.tau_shape, model.tau_mn/model.tau_shape));
