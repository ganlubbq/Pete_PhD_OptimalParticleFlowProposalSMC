...
%\newcommand{\approxoiden}[2][]{\ifstrempty{#1}{\hat{\pi}_{#2}}{\hat{\pi}_{#1|#2}}} % Approximation of the optimal importance density
...
\newcommand{\obmnapprox}[1]{\hat{\nu}_{#1}}
\newcommand{\obvrapprox}[1]{\hat{S}_{#1}}
...
\newcommand{\lgoimeanapprox}[2]{\hat{\mu}_{#1|#2}}      % Mean of the Gaussian approximation to the OID at time #1 and state #2
\newcommand{\lgoicovapprox}[2]{\hat{\Sigma}_{#1|#2}}    % Covariance of the Gaussian approximation to the OID at time #1 and state #2
\newcommand{\ctlgoimeanapprox}[1]{\hat{\mu}_{#1}}
\newcommand{\ctlgoicovapprox}[1]{\hat{\Sigma}_{#1}}
