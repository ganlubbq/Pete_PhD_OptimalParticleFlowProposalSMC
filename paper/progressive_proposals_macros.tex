...
% \newcommand{\lgmom}{H}
% \newcommand{\lgmov}{R}
\newcommand{\lgmom}[1][]{ \ifstrempty{#1}{H}{H_{#1}} }
\newcommand{\lgmov}[1][]{ \ifstrempty{#1}{R}{R_{#1}} }
...
\newcommand{\lgmomapprox}[1]{\hat{\lgmom}(#1)}       % Linear observation matrix formed by differentiation of the observation function
