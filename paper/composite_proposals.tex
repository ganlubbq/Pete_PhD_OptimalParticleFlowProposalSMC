...
\begin{IEEEeqnarray}{rCl}
 ...
 \lgoicovapprox{\pt}{\pt_0}  & = & \lgoicovapprox{\pt_0}{\pt_0}  - \obcvr{\pt_0} \left(\obvr{\pt_0}+ \frac{\obscov}{\pt_1-\pt_0}\right)^{-1} \obcvr{\pt_0} \label{eq:gaussian_moment_matching} .
\end{IEEEeqnarray}
%
...
\begin{IEEEeqnarray}{rCl}
 ...
 \lgoicovapprox{\pt_1}{\pt_0}  & = & \lgoicovapprox{\pt_0}{\pt_0}  - \obcvrapprox{\pt_0} \left(\obvrapprox{\pt_0}+ \frac{\obscov}{\pt-\pt_0}\right)^{-1} \obcvrapprox{\pt_0} \label{eq:gaussian_moment_matching_linearisation}       .
\end{IEEEeqnarray}
%
...
%
\begin{IEEEeqnarray}{rCl}
 d\ls{\pt} & = & \left[ \ctlgoicovapprox{\pt} \obsmatapprox{\ls{\pt}}^T \obscov^{-1} \left( \left(\ob{\rt} - \obsfun(\ls{\pt}) \right) + \half \obsmatapprox{\ls{\pt}} (\ls{\pt}-\ctlgoimeanapprox{\pt}) \right) - \half \lgexpsf (\ls{\pt}-\ctlgoimeanapprox{\pt}) \right] d\pt + \lgexpsf^{\half} \ctlgoicovapprox{\pt}^{\half} d\lginfbm{\pt} \label{eq:continuous_limit_state_SDE}       .
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{rCl}
 ...
 \transmeanapprox{0} & = & \ls{0} + \transcovapprox{0} \pd{\logtrans}{\ls{}}{\ls{0}} \nonumber
\end{IEEEeqnarray}
\begin{IEEEeqnarray}{rCl}
...
\begin{IEEEeqnarray}{rCl}
 ...
 \obapprox{\pt_0} & = & \ls{\pt_0} + \obscovapprox{\pt_0} \left.\frac{\partial \logobs}{\partial \ls{}}\right|_{\ls{\pt_0}} \nonumber
\end{IEEEeqnarray}
\begin{IEEEeqnarray}{rCl}
 \logobs(\ls{}) & = & \log\left(\obsden(\ob{\rt}|\ls{})\right) \nonumber      .
\end{IEEEeqnarray}
