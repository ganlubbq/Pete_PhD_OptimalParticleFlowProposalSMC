...
%
\begin{IEEEeqnarray}{rCl}
 \lgoicovapprox{\pt}{\lsfixed} & = & \left[ \frac{\partial^2}{\partial \ls{\pt}^2} \log\left(\oiden{\rt,\pt}(\ls{\rt,\pt} | \ls{\rt-1})\right) \right]^{-1} \nonumber \\
 \lgoimeanapprox{\pt}{\lsfixed} & = & \lsfixed + \lgoicovapprox{\pt}{\lsfixed} \left[ \frac{\partial}{\partial \ls{\pt}} \log\left(\oiden{\rt,\pt}(\ls{\rt,\pt} | \ls{\rt-1})\right) \right] \nonumber      .
\end{IEEEeqnarray}
%
