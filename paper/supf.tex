...
%
\begin{IEEEeqnarray}{rCl}
 \flowmap{\pt_0}{\pt_1} (\ls{\rt,\pt_0}\pss{j}) & = & \ls{\rt,\pt_0}\pss{j} + \int_{\pt_0}^{\pt_1} \flowdrift{\rt,\pt}\pss{j}(\ls{\rt,l}) dl     .
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{rCl}
 ...
 & \propto & \pw{\rt,\pt_0}\pss{j} \frac{ p(\ob{\rt} | \ls{\rt,\pt_1}\pss{j})^{\pt_1} p(\ls{\rt,\pt_1}\pss{j} | \ls{\rt-1}\pss{j}) }{ p(\ob{\rt} | \ls{\rt,\pt_0}\pss{j})^{\pt_0} p(\ls{\rt,\pt_0}\pss{j} | \ls{\rt-1}\pss{j}) } \times \frac{ \artden(\ls{\rt,\pt_0}\pss{j} | \ls{\rt,\pt_1}\pss{j}) }{ \impden(\ls{\rt,\pt_1}\pss{j} | \ls{\rt,\pt_0}\pss{j}) } \label{eq:general_weight_update}
\end{IEEEeqnarray}
%
...
%
\begin{IEEEeqnarray}{rCl}
 \artden(\ls{\rt,\pt_0} | \ls{\rt,\pt_1}) & = & \frac{ \oiden{\rt,\pt_0}(\ls{\rt,\pt_0} | \ls{\rt-1}) \impden(\ls{\rt,\pt_1} | \ls{\rt,\pt_0}) }{ \int \oiden{\rt,\pt_0}(\ls{\rt} | \ls{\rt-1}) \impden(\ls{\rt,\pt_1} | \ls{\rt}) d\ls{\rt} } \label{eq:optimal_artificial_density}     .
\end{IEEEeqnarray}
...
%
\begin{IEEEeqnarray}{rCl}
 \flowmap{\pt_0}{\pt_1} (\ls{\pt_0}) & = & \lgoimean{\pt_1} + \lgoicov{\pt_1}^{\frac{1}{2}} \lgoicov{\pt_0}^{-\frac{1}{2}} (\ls{\pt_0}-\lgoimean{\pt_0}) \label{eq:optimal_map}      .
\end{IEEEeqnarray}
%
...
%
\begin{IEEEeqnarray}{rCl}
 \lim_{\dpt\rightarrow0} \frac{ \flowmap{\pt}{\pt+\dpt} (\ls{\pt}) - \ls{\pt} }{ \dpt }  & = & \lim_{\dpt\rightarrow0} \frac{1}{\dpt} \left[ \lgoimean{\pt+\dpt} + \lgoicov{\pt+\dpt}^{\frac{1}{2}} \lgoicov{\pt}^{-\frac{1}{2}} (\ls{\pt}-\lgoimean{\pt}) - \ls{\pt} + \bigo{\dpt^2} \right] \nonumber \\
...
\begin{IEEEeqnarray}{rCl}
 \flowdrift{\pt}(\ls{\pt}) & = & \lgoicov{\pt} \obsmat^T \obscov^{-1} \left[ (\ob{\rt}-\obsmat\lgoimean{\pt}) - \frac{1}{2} \obsmat(\ls{\pt}-\lgoimean{\pt}) \right] \nonumber \\
  &   & \qquad \qquad - \: \frac{1}{2} \lfdiffsf (\ls{\pt}-\lgoimean{\pt}) + \lgoicov{\pt}^{\frac{1}{2}} \rotategen \lgoicov{\pt}^{-\frac{1}{2}} (\ls{\pt}-\lgoimean{\pt}) \nonumber       ,
\end{IEEEeqnarray}
