...
%
\begin{IEEEeqnarray}{rCl}
 \flowmap{\pt_0}{\pt_1} (\ls{\rt,\pt_0}\pss{j}) & = & \ls{\rt,\pt_0}\pss{j} + \int_{\pt_0}^{\pt_1} \flowdrift{\rt,\pt}\pss{j}(\ls{\rt,l}) dl + \int_{\pt_0}^{\pt_1} \flowdiffuse{\rt,\pt}\pss{j}(\ls{\rt,l}) d\flowbm{l}        .
\end{IEEEeqnarray}
%
