...
\begin{IEEEeqnarray}{rCl}
 ...
 \mu(\lambda)    & = & \left[ Q^{-1} + H^T \left(\frac{R}{\lambda}\right)^{-1} H \right]^{-1} \left[ Q^{-1} m + H^T \left(\frac{R}{\lambda}\right)^{-1} y \right] \\
 ...
 \mathbb{E}_{\pi}\left[ (y-Hx)^T R^{-1}(y-Hx) \right] & = & y^T R^{-1} y - 2 y^T R^{-1} H \mu(\lambda) + \mu(\lambda)^T H^T R^{-1} H \mu(\lambda) + \mathcal{T}\left( H^T R^{-1} H \Sigma(\lambda) \right) \nonumber
\end{IEEEeqnarray}
...
\IEEEeqnarraymulticol{3}{l}{ -\frac{1}{2}(y-Hx)^T R^{-1}(y-Hx) + \frac{1}{2}\mathbb{E}_{\pi}\left[ (y-Hx)^T R^{-1}(y-Hx) \right] } \nonumber \\
 \qquad & = & - \mathcal{TR}(A) - \left( A(\lambda) x_t + b(\lambda) \right)^T \left[ -Q^{-1}(x-m) + \lambda H^T R^{-1}(y-Hx) \right] \nonumber \\
\IEEEeqnarraymulticol{3}{l}{ y^T R^{-1} H (x - \mu(\lambda)) + \frac{1}{2}\left[ \mu(\lambda)^T H^T R^{-1} H \mu(\lambda) + \mathcal{TR}\left( H^T R^{-1} H \Sigma(\lambda) \right) - x^T H^T R^{-1} H x \right] } \nonumber \\
 \qquad & = & - \mathcal{TR}(A) - \left( A(\lambda) x + b(\lambda) \right)^T \left[ -Q^{-1}(x-m) + \lambda H^T R^{-1}(y-Hx) \right]      .
\end{IEEEeqnarray}
%
Now equating terms gives us the following three equations, which allow us to find values of $A$ and $b$,
%
\begin{IEEEeqnarray}{rCl}
 - \frac{1}{2} H^T R^{-1} H & = & - A(\lambda)^T \left[ -Q^{-1} - \lambda H^T R^{-1} H \right] \nonumber \\
 A(\lambda) & = & - \frac{1}{2} \left[ Q^{-1} + H^T \left(\frac{R}{\lambda}\right)^{-1} H \right]^{-1} H^T R^{-1} H \nonumber \\
...
%
\begin{IEEEeqnarray}{rCl}
 y^T R^{-1} H  & = & b(\lambda)^T \left[ Q^{-1} + \lambda H^T R^{-1} H \right] + \left[ - m^T Q^{-1} - \lambda y^T R^{-1} H \right] A(\lambda) \nonumber \\
 b(\lambda) & = & \left[ Q^{-1} + \lambda H^T R^{-1} H \right]^{-1} \left[ H^T R^{-1} y + \lambda A(\lambda)^T H^T R^{-1} y + A(\lambda)^T Q^{-1} m \right] \nonumber \\
...
\begin{IEEEeqnarray}{rCl}
 ...
 \qquad \qquad \qquad & = & - \mathcal{TR}(A) - b(\lambda)^T \left[ Q^{-1}m + \lambda H^T R^{-1} y \right]     .
\end{IEEEeqnarray}
%
Comparing the trace terms using the previously derived formula for $A(\lambda)$,
%
\begin{IEEEeqnarray}{rCl}
 - \mathcal{TR}(A) & = & \frac{1}{2} \mathcal{TR}\left( \left[ Q^{-1} + H^T \left(\frac{R}{\lambda}\right)^{-1} H \right]^{-1} H^T R^{-1} H \right) \nonumber \\
...
%
\begin{IEEEeqnarray}{rCl}
\IEEEeqnarraymulticol{3}{l}{ -y^T R^{-1} H \mu(\lambda) + \frac{1}{2} \mu(\lambda)^T H^T R^{-1} H \mu(\lambda) } \nonumber \\
 \qquad & = & \left[ -y^T + \frac{1}{2} \mu(\lambda)^T H^T \right] R^{-1} H \mu(\lambda) \nonumber \\
        & = & \left[ -y^T + \frac{1}{2} \left[ m^T Q^{-1} + y^T \left(\frac{R}{\lambda}\right)^{-1} H \right] \Sigma(\lambda) H^T \right] R^{-1} H \Sigma(\lambda) \left[ Q^{-1} m + H^T \left(\frac{R}{\lambda}\right)^{-1} y \right] \nonumber \\
        & = & - \left[ y^T R^{-1} H + \left[ m^T Q^{-1} + y^T \left(\frac{R}{\lambda}\right)^{-1} H \right] \underbrace{\left(- \frac{1}{2}\right) \Sigma(\lambda) H^T R^{-1} H}_{A(\lambda)} \right] \Sigma(\lambda) \left[ Q^{-1} m + H^T \left(\frac{R}{\lambda}\right)^{-1} y \right] \nonumber \\
        & = & - b(\lambda)^T \left[ Q^{-1}m + \lambda H^T R^{-1} y \right]
\end{IEEEeqnarray}
%
...
%
\begin{IEEEeqnarray}{rCl}
 \pi(x, \lambda) & = & \mathcal{N}(x|\mu(\lambda),\Sigma(\lambda)) = \left|\left| 2 \pi \Sigma(\lambda) \right|\right|^{-\frac{1}{2}} \exp\left\{ -\frac{1}{2} \left[ \left(x-\mu(\lambda)\right)^T \Sigma(\lambda)^{-1} \left(x-\mu(\lambda)\right) \right] \right\}      \nonumber \\
 \Sigma(\lambda) & = & \left[ Q^{-1} + H^T \left(\frac{R}{\lambda}\right)^{-1} H \right]^{-1} \nonumber \\
 \mu(\lambda)    & = & \left[ Q^{-1} + H^T \left(\frac{R}{\lambda}\right)^{-1} H \right]^{-1} \left[ Q^{-1} m + H^T \left(\frac{R}{\lambda}\right)^{-1} y \right] \nonumber     .
\end{IEEEeqnarray}
%
...
%
\begin{IEEEeqnarray}{rCl}
 y^T R^{-1} H  & = & b_D(\lambda)^T \Sigma(\lambda)^{-1} + \left[ - m^T Q^{-1} - \lambda y^T R^{-1} H \right] A_D(\lambda) - 2 \mu(\lambda)^T \Sigma(\lambda)^{-1} D(\lambda) \Sigma(\lambda)^{-1} \nonumber \\
 b_D(\lambda) & = & \Sigma(\lambda) \left[ H^T R^{-1} y + \lambda A_D(\lambda)^T H^T R^{-1} y + A_D(\lambda)^T Q^{-1} m \right] + 2 D(\lambda) \Sigma(\lambda)^{-1} \mu(\lambda) \nonumber \\
            & = & b(\lambda) + 2 D(\lambda) \Sigma(\lambda)^{-1} \mu(\lambda) \nonumber \\
            & = & b(\lambda) + 2 D(\lambda) \left[ Q^{-1} m + \lambda H^T R^{-1} y \right]     .
\end{IEEEeqnarray}
%
...
\begin{IEEEeqnarray}{rCl}
 \Sigma(\lambda) & = & \left[ Q^{-1} + H^T \left(\frac{R}{\lambda}\right)^{-1} H \right]^{-1} \nonumber \\
                 & = & Q - Q H^T \left(\left(\frac{R}{\lambda}\right)^{-1} + H Q H^T\right)^{-1} H Q     .
\end{IEEEeqnarray}

Finally, we need to check again that the constant terms balance.
%
\begin{IEEEeqnarray}{rCl}
 - \mathcal{TR}(A_D) - \mathcal{TR}\left( D(\lambda) \Sigma(\lambda)^{-1} \right) & = & - \mathcal{TR}\left( A_D + D(\lambda) \Sigma(\lambda)^{-1} \right) \nonumber \\
                   & = & \mathcal{TR}\left( \Sigma(\lambda) H^T R^{-1} H \right) \nonumber \\
                   & = & \frac{1}{2} \mathcal{TR}\left( \Sigma(\lambda) H^T R^{-1} H \right) \nonumber \\
                   & = & \frac{1}{2} \mathcal{TR}\left( H^T R^{-1} H \Sigma(\lambda) \right)      .
\end{IEEEeqnarray}
%
\begin{IEEEeqnarray}{rCl}
\IEEEeqnarraymulticol{3}{l}{ -y^T R^{-1} H \mu(\lambda) + \frac{1}{2} \mu(\lambda)^T H^T R^{-1} H \mu(\lambda) } \nonumber \\
 \qquad & = & - \left[ y^T R^{-1} H + \left[ m^T Q^{-1} + y^T \left(\frac{R}{\lambda}\right)^{-1} H \right] \underbrace{\left(- \frac{1}{2}\right) \Sigma(\lambda) H^T R^{-1} H}_{A_D(\lambda) + D(\lambda) \Sigma(\lambda)^{-1}} \right] \Sigma(\lambda) \left[ Q^{-1} m + H^T \left(\frac{R}{\lambda}\right)^{-1} y \right] \nonumber \\
        & = & - b(\lambda)^T \left[ Q^{-1}m + \lambda H^T R^{-1} y \right] - \mu(\lambda)^T \Sigma(\lambda)^{-1} D(\lambda) \left[ Q^{-1} m + H^T \left(\frac{R}{\lambda}\right)^{-1} y \right] \nonumber \\
        & = & - b_D(\lambda)^T \left[ Q^{-1}m + \lambda H^T R^{-1} y \right] + \mu(\lambda)^T \Sigma(\lambda)^{-1} D(\lambda) \left[ Q^{-1} m + H^T \left(\frac{R}{\lambda}\right)^{-1} y \right] \nonumber \\
        & = & - b_D(\lambda)^T \left[ Q^{-1}m + \lambda H^T R^{-1} y \right] + \mu(\lambda)^T \Sigma(\lambda)^{-1} D(\lambda) \Sigma(\lambda)^{-1} \mu(\lambda)     .
\end{IEEEeqnarray}
