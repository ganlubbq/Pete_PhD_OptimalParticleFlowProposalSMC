...
\begin{IEEEeqnarray}{rCl}
 ...
 & = & \wt{\lambda_0}\pij \frac{ p(y_t | \xt{\lambda_1})^{\lambda_1} p(\xt{\lambda_1} | x_{t-1}) }{ p(y_t | \xt{\lambda_0})^{\lambda_0} p(\xt{\lambda_0} | x_{t-1}) } \times \frac{ \rho(\xt{\lambda_0} | \xt{\lambda_1}) }{ q(\xt{\lambda_1}\pij | \xt{\lambda_0}\pij) }
\end{IEEEeqnarray}
%
