...
\begin{IEEEeqnarray}{rCl}
 ...
 \Gamma & = & \exp\left\{ -\frac{1}{2} \lfdiffsf \left( \pt_1 - \pt_0 \right) \right\} \lginterm{\pt_1}^{-\frac{1}{2}} \lginterm{\pt_0}^{\frac{1}{2}} \nonumber \\
 \nu    & = & \Gamma \left[ \obsmat^+ \ob{\rt} - \lginterm{\pt_0}^{-1} \left( \obsmat^+ \ob{\rt} - \transmean \right) \right] + \obsmat^+ \ob{\rt} - \lginterm{\pt_1}^{-1} \left( \obsmat^+ \ob{\rt} - \transmean \right) \nonumber \\
...
\begin{IEEEeqnarray}{rCl}
 \impden(\ls{\pt_1} | \ls{\pt_0}) & = & \normal{\ls{\pt_1}}{\Gamma \ls{\pt_0} + \nu}{\Omega} \\
 \Gamma & = & \exp\left\{ -\frac{1}{2} \lfdiffsf \left( \pt_1 - \pt_0 \right) \right\} \lginterm{\pt_1}^{-\frac{1}{2}} \lginterm{\pt_0}^{\frac{1}{2}} \nonumber \\
 \nu    & = & \exp\left\{ -\frac{1}{2} \lfdiffsf \left( \pt_1 - \pt_0 \right) \right\} \lginterm{\pt_1}^{-\frac{1}{2}} \lginterm{\pt_0}^{\frac{1}{2}} \left[ \obsmat^+ \ob{\rt} - \lginterm{\pt_0}^{-1} \left( \obsmat^+ \ob{\rt} - \transmean \right) \right] \nonumber \\
